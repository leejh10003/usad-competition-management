...
export const TeamFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TeamSelect> = z.object({
...
export const TeamFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    externalTeamId: z.boolean().optional(),
    schoolId: z.boolean().optional(),
    school: z.boolean().optional(),
...
export const TeamFindFirstOrThrowSchema: z.ZodType<Prisma.TeamFindFirstOrThrowArgs> = z.object({ select: TeamFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TeamIncludeObjectSchema.optional()), orderBy: z.union([TeamOrderByWithRelationInputObjectSchema, TeamOrderByWithRelationInputObjectSchema.array()]).optional(), where: TeamWhereInputObjectSchema.optional(), cursor: TeamWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TeamScalarFieldEnumSchema, TeamScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TeamFindFirstOrThrowArgs>;

export const TeamFindFirstOrThrowZodSchema = z.object({ select: TeamFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TeamIncludeObjectSchema.optional()), orderBy: z.union([TeamOrderByWithRelationInputObjectSchema, TeamOrderByWithRelationInputObjectSchema.array()]).optional(), where: TeamWhereInputObjectSchema.optional(), cursor: TeamWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TeamScalarFieldEnumSchema, TeamScalarFieldEnumSchema.array()]).optional() }).strict();