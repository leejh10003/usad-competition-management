...
export { SchoolResultSchema } from './School.result';
export { TeamResultSchema } from './Team.result';
export { TeamCoachRelationshipResultSchema } from './TeamCoachRelationship.result';
