...
export const SchoolFindManySelectSchema: z.ZodType<Prisma.SchoolSelect> = z.object({
...
export const SchoolFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    externalSchoolId: z.boolean().optional(),
    name: z.boolean().optional(),
    isVirtual: z.boolean().optional(),
...
export const SchoolFindManySchema: z.ZodType<Prisma.SchoolFindManyArgs> = z.object({ select: SchoolFindManySelectSchema.optional(), include: z.lazy(() => SchoolIncludeObjectSchema.optional()), orderBy: z.union([SchoolOrderByWithRelationInputObjectSchema, SchoolOrderByWithRelationInputObjectSchema.array()]).optional(), where: SchoolWhereInputObjectSchema.optional(), cursor: SchoolWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SchoolScalarFieldEnumSchema, SchoolScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SchoolFindManyArgs>;

export const SchoolFindManyZodSchema = z.object({ select: SchoolFindManySelectSchema.optional(), include: z.lazy(() => SchoolIncludeObjectSchema.optional()), orderBy: z.union([SchoolOrderByWithRelationInputObjectSchema, SchoolOrderByWithRelationInputObjectSchema.array()]).optional(), where: SchoolWhereInputObjectSchema.optional(), cursor: SchoolWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SchoolScalarFieldEnumSchema, SchoolScalarFieldEnumSchema.array()]).optional() }).strict();