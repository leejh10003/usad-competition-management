...
export const TeamCoachRelationshipFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TeamCoachRelationshipSelect> = z.object({
...
export const TeamCoachRelationshipFindFirstOrThrowSelectZodSchema = z.object({
    teamId: z.boolean().optional(),
    team: z.boolean().optional(),
    coachId: z.boolean().optional(),
    coach: z.boolean().optional()
...
export const TeamCoachRelationshipFindFirstOrThrowSchema: z.ZodType<Prisma.TeamCoachRelationshipFindFirstOrThrowArgs> = z.object({ select: TeamCoachRelationshipFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TeamCoachRelationshipIncludeObjectSchema.optional()), orderBy: z.union([TeamCoachRelationshipOrderByWithRelationInputObjectSchema, TeamCoachRelationshipOrderByWithRelationInputObjectSchema.array()]).optional(), where: TeamCoachRelationshipWhereInputObjectSchema.optional(), cursor: TeamCoachRelationshipWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TeamCoachRelationshipScalarFieldEnumSchema, TeamCoachRelationshipScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TeamCoachRelationshipFindFirstOrThrowArgs>;

export const TeamCoachRelationshipFindFirstOrThrowZodSchema = z.object({ select: TeamCoachRelationshipFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TeamCoachRelationshipIncludeObjectSchema.optional()), orderBy: z.union([TeamCoachRelationshipOrderByWithRelationInputObjectSchema, TeamCoachRelationshipOrderByWithRelationInputObjectSchema.array()]).optional(), where: TeamCoachRelationshipWhereInputObjectSchema.optional(), cursor: TeamCoachRelationshipWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TeamCoachRelationshipScalarFieldEnumSchema, TeamCoachRelationshipScalarFieldEnumSchema.array()]).optional() }).strict();