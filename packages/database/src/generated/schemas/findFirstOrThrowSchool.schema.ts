...
export const SchoolFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SchoolSelect> = z.object({
...
export const SchoolFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    externalSchoolId: z.boolean().optional(),
    name: z.boolean().optional(),
    isVirtual: z.boolean().optional(),
...
export const SchoolFindFirstOrThrowSchema: z.ZodType<Prisma.SchoolFindFirstOrThrowArgs> = z.object({ select: SchoolFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SchoolIncludeObjectSchema.optional()), orderBy: z.union([SchoolOrderByWithRelationInputObjectSchema, SchoolOrderByWithRelationInputObjectSchema.array()]).optional(), where: SchoolWhereInputObjectSchema.optional(), cursor: SchoolWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SchoolScalarFieldEnumSchema, SchoolScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SchoolFindFirstOrThrowArgs>;

export const SchoolFindFirstOrThrowZodSchema = z.object({ select: SchoolFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SchoolIncludeObjectSchema.optional()), orderBy: z.union([SchoolOrderByWithRelationInputObjectSchema, SchoolOrderByWithRelationInputObjectSchema.array()]).optional(), where: SchoolWhereInputObjectSchema.optional(), cursor: SchoolWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SchoolScalarFieldEnumSchema, SchoolScalarFieldEnumSchema.array()]).optional() }).strict();