...
export const EventCheckInFindUniqueOrThrowSchema: z.ZodType<Prisma.EventCheckInFindUniqueOrThrowArgs> = z.object({ select: EventCheckInSelectObjectSchema.optional(), include: EventCheckInIncludeObjectSchema.optional(), where: EventCheckInWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.EventCheckInFindUniqueOrThrowArgs>;

export const EventCheckInFindUniqueOrThrowZodSchema = z.object({ select: EventCheckInSelectObjectSchema.optional(), include: EventCheckInIncludeObjectSchema.optional(), where: EventCheckInWhereUniqueInputObjectSchema }).strict();