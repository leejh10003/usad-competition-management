...
export const CompetitionFindFirstSelectSchema: z.ZodType<Prisma.CompetitionSelect> = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    startsAt: z.boolean().optional(),
    endsAt: z.boolean().optional(),
    events: z.boolean().optional(),
    competitionAvailableStates: z.boolean().optional(),
...
export const CompetitionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    startsAt: z.boolean().optional(),
    endsAt: z.boolean().optional(),
...
export const CompetitionFindFirstSchema: z.ZodType<Prisma.CompetitionFindFirstArgs> = z.object({ select: CompetitionFindFirstSelectSchema.optional(), include: z.lazy(() => CompetitionIncludeObjectSchema.optional()), orderBy: z.union([CompetitionOrderByWithRelationInputObjectSchema, CompetitionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CompetitionWhereInputObjectSchema.optional(), cursor: CompetitionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CompetitionScalarFieldEnumSchema, CompetitionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CompetitionFindFirstArgs>;

export const CompetitionFindFirstZodSchema = z.object({ select: CompetitionFindFirstSelectSchema.optional(), include: z.lazy(() => CompetitionIncludeObjectSchema.optional()), orderBy: z.union([CompetitionOrderByWithRelationInputObjectSchema, CompetitionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CompetitionWhereInputObjectSchema.optional(), cursor: CompetitionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CompetitionScalarFieldEnumSchema, CompetitionScalarFieldEnumSchema.array()]).optional() }).strict();