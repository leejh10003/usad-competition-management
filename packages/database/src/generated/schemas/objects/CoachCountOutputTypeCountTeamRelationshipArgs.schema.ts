...
export const CoachCountOutputTypeCountTeamRelationshipArgsObjectSchema = makeSchema();
export const CoachCountOutputTypeCountTeamRelationshipArgsObjectZodSchema = makeSchema();
